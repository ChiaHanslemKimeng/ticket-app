# Generated by Django 5.0 on 2025-02-16 09:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='ticketImages/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_created', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboardApp.ticket')),
            ],
        ),
        migrations.CreateModel(
            name='UserFollows',
